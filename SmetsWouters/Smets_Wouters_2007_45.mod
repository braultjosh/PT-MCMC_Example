...
// According to HS, relaxed priors are: beta -> uniform + scale prior variances of all other parameters by 3, but shock priors remain unchanged
// Reference for this is the SMC paper in the online appendix
stderr ea       ,,1e-20,10              ,INV_GAMMA_PDF,0.1,2;
stderr eb       ,,1e-20,10              ,INV_GAMMA_PDF,0.1,2;
stderr eg       ,,1e-20,10              ,INV_GAMMA_PDF,0.1,2;
stderr eqs      ,,1e-20,10              ,INV_GAMMA_PDF,0.1,2;
stderr em       ,,1e-20,10              ,INV_GAMMA_PDF,0.1,2;
stderr epinf    ,,1e-20,10              ,INV_GAMMA_PDF,0.1,2;
stderr ew       ,,1e-20,10              ,INV_GAMMA_PDF,0.1,2;
crhoa           ,,1e-20,0.9999          ,UNIFORM_PDF, , ,0, 1;
crhob           ,,1e-20,0.9999          ,UNIFORM_PDF, , ,0, 1;
crhog           ,,1e-20,0.9999          ,UNIFORM_PDF, , ,0, 1;
crhoqs          ,,1e-20,0.9999          ,UNIFORM_PDF, , ,0, 1;
crhoms          ,,1e-20,0.9999          ,UNIFORM_PDF, , ,0, 1;
crhopinf        ,,1e-20,0.9999          ,UNIFORM_PDF, , ,0, 1;
crhow           ,,1e-20,0.9999          ,UNIFORM_PDF, , ,0, 1;
cmap            ,,1e-20,0.9999          ,UNIFORM_PDF, , ,0, 1;
cmaw            ,,1e-20,0.9999          ,UNIFORM_PDF, , ,0, 1;
csadjcost       ,,1e-20,20              ,NORMAL_PDF, 4, 4.5;
csigma          ,,1e-20,10              ,NORMAL_PDF, 1.50, 1.11;
chabb           ,,1e-20,0.9999          ,UNIFORM_PDF, , ,0, 1;
cprobw          ,,1e-20,0.9999          ,UNIFORM_PDF, , ,0, 1;
csigl           ,,1e-20,10              ,NORMAL_PDF,2,2.25;
cprobp          ,,1e-20,0.9999          ,UNIFORM_PDF, , ,0, 1;
cindw           ,,1e-20,0.9999          ,UNIFORM_PDF, , ,0, 1;
cindp           ,,1e-20,0.9999          ,UNIFORM_PDF, , ,0, 1;
czcap           ,,1e-20,0.9999          ,UNIFORM_PDF, , ,0, 1;
cfc             ,,1e-20,10              ,NORMAL_PDF,1.25,0.36;
crpi            ,,1,10                  ,NORMAL_PDF,1.5,0.75;
crr             ,,1e-20,0.9999          ,UNIFORM_PDF, , , 0, 1;
cry             ,,1e-20,1               ,NORMAL_PDF,0.12,0.15;
crdy            ,,1e-20,1               ,NORMAL_PDF,0.12,0.15;
constepinf      ,,-5,5                  ,GAMMA_PDF,0.625,0.3;
constebeta      ,,1e-20,2               ,GAMMA_PDF,0.25,0.3;
constelab       ,,-30,30                ,NORMAL_PDF,0,6;
ctrend          ,,1e-20,1               ,NORMAL_PDF,0.4,0.30;
cgy             ,,1e-20,1               ,UNIFORM_PDF, , ,0, 1;
calfa           ,,1e-20,1               ,NORMAL_PDF,0.3,0.15;
end;

varobs dy dc dinve labobs pinfobs dw robs;
set_dynare_seed('clock');
estimation(datafile = usdata_sw_mat, mh_replic=0, nograph, nodiagnostic, mode_compute=0, presample = 4);

//estimation(datafile = usdata_sw_mat, mh_replic=0, nograph, nodiagnostic, mode_compute=0, mode_file = usmodel_mode, presample = 4);
//stoch_simul(order = 1, nograph, irf = 20) dy dc dinve labobs pinfobs dw robs;
